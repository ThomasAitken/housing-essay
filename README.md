# Data Analysis for "The Real Causes of High House Prices: A Rigorous, Global Perspective"

This is the repo accompanying my Substack post, "The Real Causes of High House Prices: A Rigorous, Global Perspective". This is not my finest work as a programmer; it just a rough-and-ready collection of the scripts that I wrote (with AI assistance) to generate the datasets and charts that informed my essay.
